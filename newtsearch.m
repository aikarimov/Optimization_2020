function [xmin, fmin, neval] = newtsearch(f,df,x0,tol)
% NEWTSEARCH searches for minimum using Newton multidimensional method
% 	[xmin, fmin, neval] = NEWTSEARCH(f,df,x0,tol)
%   INPUT ARGUMENTS
